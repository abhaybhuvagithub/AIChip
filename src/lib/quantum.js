...
export const MODALITIES = [
  {
    id: 'transmon', name: 'Superconducting transmon', temp: '~15 mK',
  ...
  {
    id: 'ion', name: 'Trapped ion', temp: 'Room-temp trap, laser-cooled ions',
  ...
  {
    id: 'atom', name: 'Neutral atom', temp: 'Room-temp chamber, µK atoms',
  ...
  {
    id: 'spin', name: 'Silicon spin', temp: '~100 mK–1 K',
  ...
  {
    id: 'photonic', name: 'Photonic', temp: 'Room temperature (detectors cryogenic)',

    ...
    <div>
      ...
      <div className="grid g2">
        ...
        <div className="card">
          ...
          <h3 style={{ fontFamily: 'var(--font-display)', fontSize: 22, letterSpacing: '-.02em' }}>{a.name}</h3>
          <p style={{ fontSize: 14.5, lineHeight: 1.62, marginTop: 10 }}>{a.why}</p>
        </div>
      </div>
              ...
              <tr key={n.node}>
                ...
                <td>
                  <div className="row" style={{ gap: 8, flexWrap: 'nowrap' }}>
                    ...
                    <span className="num" style={{ fontSize: 12, color: 'var(--muted)', minWidth: 38, textAlign: 'right' }}>{fmt.n(n.mtr, n.mtr < 10 ? 1 : 0)}</span>
                  </div>
                </td>

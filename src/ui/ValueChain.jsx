    ...
    <div>
      ...
      <div className="detail">
        <div className="card">
          ...
          <p style={{ fontSize: 14.5, lineHeight: 1.62, marginTop: 8 }}>{l.what}</p>
          <p className="phys" style={{ fontSize: 14.5, lineHeight: 1.62 }}>{l.capture}</p>
        </div>
        <div className="card">
          <dl className="kv">
            <dt>Who is in it</dt>
      ...
      <div className="card">
        <p style={{ fontSize: 14.5, lineHeight: 1.62 }}>{ARM.what}</p>
      </div>
      ...
      <div className="grid g2" style={{ marginTop: 12 }}>
        <div className="card" style={{ borderColor: 'var(--accent)' }}>
          ...
          <p style={{ fontSize: 14.5, lineHeight: 1.62, marginTop: 8 }}>{ARM.ownSilicon}</p>
        </div>
        <div className="card">
          <div className="eyebrow">And the pressure from below</div>
          <p style={{ fontSize: 14.5, lineHeight: 1.62, marginTop: 8 }}>{ARM.tension}</p>
        </div>
      </div>
      ...
      <div className="detail">
        <div className="card">
          ...
          <h3 style={{ fontFamily: 'var(--font-display)', fontSize: 21, letterSpacing: '-.02em' }}>{m.name}</h3>
          <p style={{ fontSize: 14.5, lineHeight: 1.62, marginTop: 10 }}>{m.how}</p>
        </div>
        <div className="card">
          <dl className="kv">
      ...
      <div className="grid g3">
        <div className="stat hi">
          ...
          <div className="v">{fmt.n(t.wpm / 1000)}k<span style={{ fontSize: 15 }}>/mo</span></div>
      ...
      <div className="card" style={{ borderColor: 'var(--warn)' }}>
        ...
        <p style={{ fontSize: 14.5, lineHeight: 1.62, marginTop: 10 }}>{TERAFAB.why}</p>
      </div>
      ...
      <div className="card" style={{ marginTop: 12 }}>
        ...
        <p style={{ fontSize: 14.5, lineHeight: 1.62, marginTop: 8 }}>{TERAFAB.against}</p>
      </div>

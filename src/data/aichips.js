...
export const ARCHITECTURES = [
  {
    id: 'simt', name: 'SIMT', short: 'SIMT', icon: 'gpu', example: 'NVIDIA, AMD GPUs',
  ...
  {
    id: 'systolic', name: 'Systolic array', short: 'Systolic', icon: 'npu', example: 'Google TPU',
  ...
  {
    id: 'dataflow', name: 'Spatial dataflow', short: 'Dataflow', icon: 'waferscale', example: 'Cerebras, Groq, SambaNova',
  ...
  {
    id: 'vliw', name: 'VLIW and vector', short: 'VLIW', icon: 'ipdsp', example: 'Many mobile NPUs, some DSPs',
  ...
  {
    id: 'inmem', name: 'In-memory / analogue', short: 'In-memory', icon: 'ipmem', example: 'Research, and a few startups',
...
export const WORKLOADS = [
  {
    id: 'train', name: 'Training', short: 'Training', icon: 'chart',
  ...
  {
    id: 'prefill', name: 'Inference — prefill', short: 'Prefill', icon: 'ipnoc',
  ...
  {
    id: 'decode', name: 'Inference — decode', short: 'Decode', icon: 'ipmem',

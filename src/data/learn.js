...
export const TOUR = [
  { id: 't0000', tab: 'operate', title: 'Meet the operator', body: 'Run & Operate runs a chip company on a stated policy — six rules, in order, that you can read before you run it. It is not a language model and there is none behind it. Every decision it makes comes with the numbers that produced it.' },
  { id: 't0001', tab: 'operate', title: 'Override the gate and watch', body: 'In automotive, the operator holds shipment for seven quarters rather than breach one part per million. Override it and the company ships early, earns well, and gets designed out. Switch to consumer and the same comparison changes sign — the discipline falls out of who the customer is, not from a principle.' },
  ...
  { id: 't00', tab: 'top', title: 'Start where everything connects', body: 'Top view shows one configuration and every consequence of it at once — grams of rock, process steps, dies per wafer, cost, compute, cooling class. Click any node in the chain to jump to the tab that owns it.' },
  { id: 't01', tab: 'top', title: 'Ask instead of hunting', body: 'The ✨ button, bottom right, opens an assistant that reads the live state and computes answers. Try "what is the bottleneck" or "why is my yield low". It has no server behind it, so if it cannot ground an answer it says so.' },

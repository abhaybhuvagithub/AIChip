...
export const TOUR = [
  { id: 't0000', tab: 'javy', title: 'Meet the operator', body: 'Javy runs a chip company on a stated policy — six rules, in order, that you can read before you run it. It is not a language model and there is none behind it. Every decision it makes comes with the numbers that produced it.' },
  { id: 't0001', tab: 'javy', title: 'Override the gate and watch', body: 'In automotive, Javy holds shipment for seven quarters rather than breach one part per million. Override it and the company ships early, earns well, and gets designed out. Switch to consumer and the same comparison changes sign — the discipline falls out of who the customer is, not from a principle.' },
